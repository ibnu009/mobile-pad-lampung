...
class TransactionToiletPaymentPage extends StatefulWidget {
  const TransactionToiletPaymentPage({Key? key}) : super(key: key);

  @override
  State<TransactionToiletPaymentPage> createState() =>
      _TransactionToiletPaymentPageState();
}

class _TransactionToiletPaymentPageState
    extends State<TransactionToiletPaymentPage> {
        ...
        child: Column(
          ...
          children: [
            const Padding(
              ...
              child: GenericAppBar(url: '', title: 'Toilet'),
            ),
            const SizedBox(
              height: 12,
            ),
            SvgPicture.asset(
                height: 244, width: 244, 'assets/icons/toilet_icon.svg'),
            Container(
              ...
              child: Column(children: [
                const Text('Harga Fasilitas Toilet'),
                Text(
                  'Rp 5.000 / Orang',
